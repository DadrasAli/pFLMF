...
class FedAvgClient:
    def __init__(
        ...
        if lr_scheduler_cls is not None:
            ...
            #print("Learning Rate Scheduler State:", self.lr_scheduler.state_dict())
    ...
    def set_parameters(self, package: dict[str, Any]):
        ...
        if self.lr_scheduler is not None:
            if package["lr_scheduler_state"]:
                ...
                # Apply the last known learning rate from the scheduler state
                for param_group, last_lr in zip(self.optimizer.param_groups, self.lr_scheduler.state_dict()['_last_lr']):
    ...
    def fit(self):
        ...
        for epoch in range(self.local_epoch):
            ...
            if self.lr_scheduler is not None:
                ...
                #print(f"Client {self.client_id}, Epoch {epoch+1}/{self.local_epoch}: LR {old_lr:.6f} -> {new_lr:.6f}")
                #print(f"Current scheduler state: {self.lr_scheduler.state_dict()}")
